...
: ${_CONF_DEV_CHECKSTYLE_VERSION:=10.12.4}
...
java -jar /usr/local/walterjwhite/dev/checkstyle/checkstyle.jar -c /usr/local/walterjwhite/dev/checkstyle/checks/${_CONF_DEV_CHECKSTYLE_VERSION_STYLE}_checks.xml "$@"
